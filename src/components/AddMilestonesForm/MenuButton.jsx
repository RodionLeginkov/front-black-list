...
export default function MenuButton(props) {
  ...
  const promoteMilestone = {
    ...
    person_uuid: singleMilestone.person_uuid || null,
    role: singleMilestone.role || '',
    rate: singleMilestone.rate || null,
    rate_type: singleMilestone.rate_type || '',
    load: singleMilestone.load || null,
    start_date: singleMilestone.end_date || new Date(),
    end_date: null,
    Users: singleMilestone.Users,
    platform: singleMilestone.platform || '',
    withdraw: singleMilestone.withdraw || '',
    comment: '',
    status: 'Active',
  };
