...
export const userTableCells = [
  ...
  { label: 'Current project', value: 'current_project' },
  { label: 'Role in the project', value: 'role_in_project' },
  { label: 'Current rate', value: 'current_rate' },
  { label: 'Load(h/week)', value: 'load' },
